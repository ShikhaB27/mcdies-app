	    ...
	    switch (actionName) {
			...
			case 'check_permission': {
							 ...
							 if(isDefined(actionName)){
								...
								console.log(lat);
								console.log(lng);
								text= `Thank you for giving me the permission ! I can place an order for you at the nearest McDonalds, which is a 10 minutes walk from your current location. What would you like to order?`
								}else{
